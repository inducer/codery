    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coder', models.ForeignKey(to=settings.AUTH_USER_MODEL, to_field='id', on_delete=models.CASCADE)),
                ('piece', models.ForeignKey(to='pieces.Piece', to_field='id', on_delete=models.CASCADE)),
                ('sample', models.ForeignKey(to='coding.Sample', to_field='id', on_delete=models.CASCADE)),
